...
const projectsData = [
    ...
    {
        name: "The Speed of Money",
        coverImage: "cover5.jpg",
        overview: "Designed as E-Cell IIT Roorkee's most anticipated weekly knowledge session of the year, the talk traced the entire timeline of Indian money: barter systems → hundi → British banking → post-independence RBI framework → demonetization → UPI revolution → rise of crypto → RBI's e-Rupee pilot and future CBDC roadmap. The second half deep-dived into the \"speed of money\" in modern markets: statistical & triangular arbitrage, payment-for-order-flow controversies, Jane Street's ETF manipulation case, high-frequency trading concepts, and practical share-market strategies, followed by 45+ minutes of rigorous cross-questioning from the audience.",
        about: "Conducted in a packed auditorium with 120+ E-Cell members in March 2025, the session combined historical storytelling, live UPI transaction demos, crypto wallet breakdowns, leaked Jane Street internal strategy snippets, and real-time arbitrage opportunity calculations. Key topics covered:\n\nEvolution of Indian monetary systems and velocity of money over centuries\nHow UPI achieved 50%+ of global real-time payment volume\nCrypto adoption vs. regulatory crackdown in India\ne-Rupee (CBDC) mechanics and its impact on commercial banks\nArbitrage types: statistical, triangular, latency, retail vs. institutional\nJane Street's $1B+ ETF creator manipulation case explained\nCore trading concepts: liquidity, slippage, dark pools, order-book dynamics\n\nThe session ended with an intense 45-minute rapid-fire Q&A where members grilled on regulatory risks, taxable events in crypto, feasibility of retail HFT in India, and ethical boundaries of market making. Rated 4.9/5 by attendees, it remains one of E-Cell IIT Roorkee's highest-attended and most intense knowledge sessions of 2025, with recordings still circulated among finance enthusiasts on campus.",
        caseStudyLink: "https://drive.google.com/file/d/1JyaIEIE6sDHb6CSFU640fu7EeT_HAr5j/view?usp=sharing"
    }
];
